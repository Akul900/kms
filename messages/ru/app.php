...
return [
    ...
    'NAV_ADD_MAJORITY_VALVE' => 'Мажоритарный вентиль',
    'NAV_ADD_AND_WITH_PRIORITY' => 'И с приоритетом',
    'NAV_ADD_NOT' => 'Не',
    'NAV_ADD_TRANSFER_VALVE' => 'Вентиль переноса',
    'NAV_HIDDEN_EVENT' => 'Скрытое событие',
    'NAV_CONDITIONAL_EVENT' => 'Условное событие',
    ...
    'FAULT_ADD_NEW_UNDEVELOPED_EVENT' => 'Добавить новое неразвитое событие',
    'FAULT_ADD_NEW_HIDDEN_EVENT' => 'Добавить новое скрытое событие',
    'FAULT_ADD_NEW_CONDITIONAL_EVENT' => 'Добавить новое условное событие',
    'FAULT_ADD_NEW_TRANSFER_VALVE' => 'Добавить новый вентиль переноса',
    'BASIC_EVENT_EDIT_BASIC_EVENT' => 'Изменение базисного события',
    'TRANSFER_VALVE_EDIT_TRANSFER_VALVE' => 'Изменение вентиля переноса',
    ...
    'MAJORITY_VALVE_DELETE_MAJORITY_VALVE' => 'Удаление Мажоритарного вентиля',
    'AND_WITH_PRIORITY_DELETE_AND_WITH_PRIORITY' => 'Удаление И с приоритетом',
    'UNDEVELOPED_EVENT_EDIT_UNDEVELOPED_EVENT' => 'Изменение скрытого события',
    'UNDEVELOPED_EVENT_DELETE_UNDEVELOPED_EVENT' => 'Удаление скрытого события',
    'HIDDEN_EVENT_EDIT_HIDDEN_EVENT' => 'Изменение условного события',
    'HIDDEN_EVENT_DELETE_HIDDEN_EVENT' => 'Удаление условного события',
    'CONDITIONAL_EVENT_EDIT_CONDITIONAL_EVENT' => 'Изменение неразвитого события',
    'CONDITIONAL_EVENT_DELETE_CONDITIONAL_EVENT' => 'Удаление неразвитого события',
    'NOT_DELETE_NOT' => 'Удаление Не',
    'TRANSFER_VALVE_DELETE_TRANSFER_VALVE' => 'Удаление Вентиля переноса',
    ...
    'DELETE_MAJORITY_VALVE_TEXT' => 'Вы действительно хотите удалить Мажоритарный вентиль?',
    'DELETE_ADD_AND_WITH_PRIORITY_TEXT' => 'Вы действительно хотите удалить И с приоритетом?',
    'DELETE_NOT_TEXT' => 'Вы действительно хотите удалить Не?',
    'DELETE_UNDEVELOPED_EVENT_TEXT' => 'Вы действительно хотите удалить неразвитое событие?',
    'DELETE_HIDDEN_EVENT_TEXT' => 'Вы действительно хотите удалить скрытое событие?',
    'DELETE_CONDITIONAL_EVENT_TEXT' => 'Вы действительно хотите удалить условное событие?',
    'DELETE_TRANSFER_VALVE_TEXT' => 'Вы действительно хотите удалить Вентиль переноса?',
