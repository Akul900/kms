...
class State extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['diagram'], 'exist', 'skipOnError' => true, 'targetClass' => Diagram::class,
    ...
    {
        return $this->hasOne(Diagram::class, ['id' => 'diagram']);
    }
    ...
    {
        return $this->hasMany(StateProperty::class, ['state' => 'id']);
    }
    ...
    {
        return $this->hasMany(Transition::class, ['state_from' => 'id']);
    }
    ...
    {
        return $this->hasMany(Transition::class, ['state_to' => 'id']);
    }
