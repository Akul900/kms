...
<?php Modal::begin([
    'id' => 'addFaultModalForm',
    'title' => '<h3>' . Yii::t('app', 'FAULT_ADD_NEW_FAULT') . '</h3>',
]); ?>
    ...
    $(document).ready(function() {
        ...
        $("#add-state-button").click(function(e) {
            ...
            $.ajax({
                ...
                '/fault-tree-diagrams/add-state/' . $model->id ?>",
                type: "post",
                data: form.serialize(),
                dataType: "json",
        ...
        $(document).ready(function() {
            ...
            $("#edit-state-button").click(function(e) {
                ...
                $.ajax({
                    //переход на экшен левел
                    url: "<?= Yii::$app->request->baseUrl . '/' . Lang::getCurrent()->url .
                    '/fault-tree-diagrams/edit-state'?>",
                    type: "post",
        ...
        $(document).ready(function() {
            ...
            $("#delete-state-button").click(function(e) {
                ...
                $.ajax({
                    //переход на экшен левел
                    url: "<?= Yii::$app->request->baseUrl . '/' . Lang::getCurrent()->url .
                    '/fault-tree-diagrams/delete-state'?>",
                    type: "post",
    ...
    $(document).ready(function() {
        ...
        $("#copy-state-button").click(function(e) {
            ...
            $.ajax({
                //переход на экшен левел
                url: "<?= Yii::$app->request->baseUrl . '/' . Lang::getCurrent()->url .
                '/fault-tree-diagrams/copy-state'?>",
                type: "post",
                data: form.serialize() + "&state_id_on_click=" + state_id_on_click,
                dataType: "json",
                success: function(data) {
